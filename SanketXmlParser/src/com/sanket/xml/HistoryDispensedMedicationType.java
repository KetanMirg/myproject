...
/**
 * <p>Java class for HistoryDispensedMedicationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="HistoryDispensedMedicationType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Quantity" type="{http://www.surescripts.com/messaging}HistoryQuantityType" maxOccurs="2" minOccurs="0"/>
 *         &lt;element name="DaysSupply" type="{http://www.surescripts.com/messaging}an..35" minOccurs="0"/>
 ...
 *         &lt;element name="Refills" type="{http://www.surescripts.com/messaging}MedicationHistoryRefillsType" maxOccurs="2" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.surescripts.com/messaging}LastFillDate"/>
 ...
 *         &lt;element ref="{http://www.surescripts.com/messaging}SoldDate" minOccurs="0"/>
 ...
 *         &lt;element name="DrugUseEvaluation" type="{http://www.surescripts.com/messaging}HistoryDrugUseEvaluationType" maxOccurs="5" minOccurs="0"/>
 *         &lt;element name="DrugCoverageStatusCode" maxOccurs="5" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *               &lt;pattern value="PR|AP|PA|NF|NR|DC|UN|ST"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 ...
 *         &lt;element name="HistorySource" type="{http://www.surescripts.com/messaging}HistorySourceType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "HistoryDispensedMedicationType", propOrder = {
    "drugDescription",
    "drugCoded",
    "quantity",
    "daysSupply",
...
public class HistoryDispensedMedicationType {
    ...
    protected List<HistoryQuantityType> quantity;
    ...
    protected List<MedicationHistoryRefillsType> refills;
    ...
    protected List<HistoryDrugUseEvaluationType> drugUseEvaluation;
    ...
    protected HistorySourceType historySource;
     ...
     * {@link HistoryQuantityType }
     * 
     * 
     */
    public List<HistoryQuantityType> getQuantity() {
        if (quantity == null) {
            quantity = new ArrayList<HistoryQuantityType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MedicationHistoryRefillsType }
     * 
     * 
     */
    public List<MedicationHistoryRefillsType> getRefills() {
        if (refills == null) {
            refills = new ArrayList<MedicationHistoryRefillsType>();
        }
        return this.refills;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HistoryDrugUseEvaluationType }
     * 
     * 
     */
    public List<HistoryDrugUseEvaluationType> getDrugUseEvaluation() {
        if (drugUseEvaluation == null) {
            drugUseEvaluation = new ArrayList<HistoryDrugUseEvaluationType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link HistorySourceType }
     *     
     */
    public HistorySourceType getHistorySource() {
     ...
     *     
     */
    public void setHistorySource(HistorySourceType value) {
